...
class QueryUtils {
    ...
    * @param {String} carNumber commercial paper number
    */
    async getAssetHistory(issuer, carNumber) {

        let ledgerKey = await this.ctx.stub.createCompositeKey(this.name, [issuer, carNumber]);
